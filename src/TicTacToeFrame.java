...
public class TicTacToeFrame implements ActionListener {
    ...
    private JFrame game = new JFrame("Tic Tac Toe by Romit Gupta");
...
//Displaying an X or O on the buttons
    ...
    public void createButtonPnl()
    {
        ...
        resetBtn.addActionListener((ActionEvent ae) -> {
            int reply = JOptionPane.showConfirmDialog(null, "Are you sure, you want to reset the game?", "Confirm", JOptionPane.YES_NO_OPTION);
        ...
        quitBtn.addActionListener((ActionEvent ae) -> {
            int reply = JOptionPane.showConfirmDialog(null, "Are you sure you want to exit?", "Quitting Tic Tac Toe", JOptionPane.YES_NO_OPTION);
            if (reply == JOptionPane.YES_OPTION)
            {
                System.exit(0);
            }
